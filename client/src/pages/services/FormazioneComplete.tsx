...
export default function FormazioneComplete() {
  const categories = [
    ...
    },
    {
      ...
      icon: Wrench,
      courses: [
        { title: "Corso per Addetti alla Conduzione di Piattaforme di Lavoro Elevabili (PLAE)", duration: "TBD", url: "/servizi/formazione/piattaforme-elevabili" },
        { title: "Corso Aggiornamento per Addetti alla Conduzione di Piattaforme di Lavoro Elevabili", duration: "TBD", url: "/servizi/formazione/aggiornamento-piattaforme-elevabili" },
        { title: "Corso per Addetti e Preposti Montaggio, Smontaggio e Trasformazione di Ponteggi", duration: "TBD", url: "/servizi/formazione/ponteggi" },
        { title: "Corso Aggiornamento Addetti e Preposti Montaggio, Smontaggio e Trasformazione di Ponteggi", duration: "TBD", url: "/servizi/formazione/aggiornamento-ponteggi" },
        { title: "Corso Utilizzo DPI Anticaduta (DPI 3° Categoria)", duration: "TBD", url: "/servizi/formazione/dpi-anticaduta" },
        { title: "Corso di Aggiornamento DPI Anticaduta", duration: "TBD", url: "/servizi/formazione/aggiornamento-dpi-anticaduta" },
        { title: "Corso per Addetti alla Conduzione di Escavatori", duration: "TBD", url: "/servizi/formazione/escavatori" },
        { title: "Corso Aggiornamento per Addetti alla Conduzione di Escavatori", duration: "TBD", url: "/servizi/formazione/aggiornamento-escavatori" },
        { title: "Corso per Addetti alla Conduzione Carroponte con Comando", duration: "TBD", url: "/servizi/formazione/carroponte" },
        { title: "Corso Aggiornamento per Addetti alla Conduzione Carroponte con Comando", duration: "TBD", url: "/servizi/formazione/aggiornamento-carroponte" },
        { title: "Corso per Addetti alla Conduzione di Gru per Autocarro", duration: "TBD", url: "/servizi/formazione/gru-autocarro" },
        { title: "Corso di Aggiornamento per Addetti alla Conduzione di Gru per Autocarro", duration: "TBD", url: "/servizi/formazione/aggiornamento-gru-autocarro" },
        { title: "Corso Addetto Segnaletica Stradale", duration: "TBD", url: "/servizi/formazione/segnaletica-strada" },
        { title: "Corso di Aggiornamento Addetto alla Segnaletica Stradale", duration: "TBD", url: "/servizi/formazione/aggiornamento-segnaletica-strada" },
        { title: "Corso Preposti Stradali", duration: "TBD", url: "/servizi/formazione/preposti-stradali" },
        { title: "Corso di Aggiornamento Preposti Stradali", duration: "TBD", url: "/servizi/formazione/aggiornamento-preposti-stradali" },
        { title: "Corso per Addetti alla Conduzione di Trattori Agricoli", duration: "TBD", url: "/servizi/formazione/trattori-agricoli" },
        { title: "Corso Aggiornamento per Addetti alla Conduzione di Trattori Agricoli", duration: "TBD", url: "/servizi/formazione/aggiornamento-trattori-agricoli" },
        { title: "Corso per Lavoratori che Operano in Ambienti Sospetti di Inquinamento", duration: "TBD", url: "/servizi/formazione/ambienti-sospetti" },
        { title: "Corso di Aggiornamento per Lavoratori che Operano in Ambienti Sospetti di Inquinamento", duration: "TBD", url: "/servizi/formazione/aggiornamento-ambienti-sospetti" },
        { title: "Corso PES/PAV", duration: "TBD", url: "/servizi/formazione/pespav" },
        { title: "Corso Aggiornamento PES/PAV", duration: "TBD", url: "/servizi/formazione/aggiornamento-pespav" },
      ],
    },
  ];
