...
export default function RSPPCourse() {
  return (
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4 leading-relaxed">
                Il corso RSPP (Responsabile del Servizio di Prevenzione e Protezione) è una 
                formazione obbligatoria per chi ricopre il ruolo di responsabile della sicurezza 
                in azienda. Fornisce competenze approfondite sulla gestione della sicurezza, 
                valutazione dei rischi, normativa e conformità.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                L'RSPP è la figura centrale nella gestione della sicurezza aziendale e ha 
                responsabilità importanti nel coordinamento delle attività di prevenzione 
            ...
            <section>
              ...
              <ul className="space-y-3">
                {[
                  "Responsabili della sicurezza già designati",
                  "Manager e coordinatori di sicurezza",
                  "Imprenditori e titolari di azienda",
                  "Chi vuole acquisire competenze specifiche in sicurezza",
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Il corso RSPP è strutturato in moduli tematici che combinano lezioni teoriche 
                con esercitazioni pratiche e case study reali:
              </p>
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Modulo A (28 ore)</h3>
                  <p className="text-sm text-muted-foreground">
                    Fondamenti della sicurezza sul lavoro, normativa, principi di prevenzione, 
                    organizzazione della sicurezza.
                  </p>
                </div>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Modulo B (48 ore)</h3>
                  <p className="text-sm text-muted-foreground">
                    Valutazione dei rischi, metodologie di analisi, gestione dei processi, 
                    comunicazione della sicurezza.
                  </p>
                </div>
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Modulo C (24 ore)</h3>
                  <p className="text-sm text-muted-foreground">
                    Specializzazione per settore (costruzioni, industria, servizi, ecc.) 
              ...
              <div className="bg-gray-50 border rounded-lg p-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">100 ore (Modulo A + B + C)</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Solitamente 2-3 giorni a settimana per 6-8 settimane
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      5 anni (aggiornamento obbligatorio ogni 5 anni: 40 ore)
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  <summary className="font-semibold text-gray-900 flex items-center justify-between">
                    Modulo A - Normativa e Organizzazione (28 ore)
                    <span className="group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• D.Lgs 81/08 e normativa sulla sicurezza</p>
                    <p>• Soggetti della prevenzione e loro obblighi</p>
                    <p>• Diritti e doveri dei lavoratori</p>
                    <p>• Organizzazione della prevenzione in azienda</p>
                    <p>• Principi di prevenzione e protezione</p>
                ...
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  <summary className="font-semibold text-gray-900 flex items-center justify-between">
                    Modulo B - Valutazione e Gestione dei Rischi (48 ore)
                    <span className="group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Metodologie di valutazione dei rischi</p>
                    <p>• Analisi dei rischi per settore</p>
                    <p>• Redazione del DVR (Documento Valutazione Rischi)</p>
                    <p>• Gestione dei processi di prevenzione</p>
                    <p>• Comunicazione e partecipazione dei lavoratori</p>
                ...
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  <summary className="font-semibold text-gray-900 flex items-center justify-between">
                    Modulo C - Specializzazione per Settore (24 ore)
                    <span className="group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Rischi specifici del settore</p>
                    <p>• Normativa settoriale</p>
                    <p>• Buone pratiche nel settore</p>
                    <p>• Case study e esempi pratici</p>
                  </div>
                </details>
              </div>
            </section>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 sticky top-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="font-semibold text-gray-900">100 ore</p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">Da 600 EUR + IVA</p>
                </div>
              ...
              {/* CTA */}
              <a
                href="https://wa.me/393465835685?text=Sono%20interessato%20al%20corso%20RSPP"
                target="_blank"
