...
export default function DatoriLavoro() {
  return (
    <CourseTemplate
      title="Corso per Datori di Lavoro"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="16 ore"
      type="presenza"
      location="Catania"
      description="Corso Corso per Datori di Lavoro. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
