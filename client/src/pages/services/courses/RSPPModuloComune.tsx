...
export default function RSPPModuloComune() {
  return (
    <CourseTemplate
      title="Corso per Datori di Lavoro RSPP - Modulo Comune"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="da 150,00 euro"
      type="presenza"
      location="Catania"
      description="Corso Corso per Datori di Lavoro RSPP - Modulo Comune. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
