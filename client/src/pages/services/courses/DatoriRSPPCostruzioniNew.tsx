...
export default function DatoriRSPPCostruzioniNew() {
  return (
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Modulo Integrativo Costruzioni</span>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                ...
                <img 
                  ...
                  alt="RSPP Costruzioni" 
                  className="w-full h-auto rounded-lg shadow-lg"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-orange-900 to-transparent p-6 rounded-lg">
                  <p className="text-white font-bold text-lg">SETTORE COSTRUZIONI</p>
                </div>
              </div>

              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso RSPP - Modulo Integrativo Costruzioni</h1>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>16 ore</strong> - Modulo specialistico per settore costruzioni
                </p>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20RSPP%20Modulo%20Costruzioni"
                  target="_blank"
          ...
          <div className="container">
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Questo modulo integrativo è specificamente dedicato al settore <strong>Costruzioni</strong> e fornisce al datore di lavoro <strong>informazioni specifiche per gestire in autonomia il Servizio di Prevenzione e Protezione dai rischi professionali</strong> nel settore indicato.
                </p>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-orange-50 border-l-4 border-orange-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Il modulo tecnico-integrativo è rivolto a <strong>tutti i titolari d'impresa che svolgano direttamente i compiti del Servizio di Prevenzione e Protezione nel settore Costruzioni</strong> e che abbiano già frequentato il modulo generale di 8 ore.
                </p>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Il modulo integrativo Costruzioni prevede la trattazione dei seguenti argomenti:
                </p>

                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Soggetti definiti dal Titolo IV capo I, e relativi obblighi e responsabilità</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Organizzazione, tecniche e fasi lavorative, aree di lavoro dei cantieri</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Le misure generali di tutela secondo quanto previsto dall'art. 95 del d.lgs. n. 81/2008</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Il piano operativo di sicurezza (POS)</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Cenni sul PSC (Piano di Sicurezza e Coordinamento)</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Cadute dall'alto e opere provvisionali</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Lavori di demolizione e scavo</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Impianti elettrici e illuminazione di cantiere</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Rischi legati all'utilizzo di macchine e attrezzature di lavoro</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Movimentazione dei carichi manuale e meccanica</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Rischio incendio ed esplosione</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Dispositivi di protezione collettiva e individuali</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Attività su sedi stradali</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Esempi e analisi di un POS</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground">
                  <strong>16 ore</strong> (modulo specialistico per il settore costruzioni)
                </p>
              </div>
