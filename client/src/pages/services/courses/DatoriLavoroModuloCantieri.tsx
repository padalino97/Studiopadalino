...
export default function DatoriLavoroModuloCantieri() {
  return (
    <CourseTemplate
      title="Corso per Datori di Lavoro Modulo Aggiuntivo Cantieri"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="6 ore"
      type="presenza"
      location="Catania"
      description="Corso Corso per Datori di Lavoro Modulo Aggiuntivo Cantieri. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
