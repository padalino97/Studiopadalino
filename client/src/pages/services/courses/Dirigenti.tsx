...
export default function DirigentiCourse() {
  return (
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-12">
        <div className="container">
          ...
          <p className="text-xl text-gray-300">
            Responsabilità e compiti dei dirigenti in sicurezza
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-gray-900 mb-4">
                Cos'è il Corso Dirigenti?
              </h2>
              <p className="text-muted-foreground mb-4 leading-relaxed">
                Il dirigente è la persona che, in ragione delle competenze professionali e della 
                posizione gerarchica, attua le direttive del datore di lavoro e organizza l'attività 
                lavorativa. Il corso fornisce le competenze necessarie per gestire la sicurezza 
                secondo il D.Lgs 81/08.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                I dirigenti hanno responsabilità importanti nella prevenzione dei rischi e nella 
                gestione della sicurezza aziendale. Questo corso sostituisce la formazione 
            ...
            <section>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Responsabili di funzione e dipartimento",
                  "Direttori di stabilimento o filiale",
                  "Chiunque abbia responsabilità di gestione aziendale",
                  "Datori di lavoro che delegano funzioni di dirigente",
                ].map((item, i) => (
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                ...
                per sviluppare competenze di gestione della sicurezza a livello dirigenziale.
              </p>
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Modulo Teorico (12 ore)</h3>
                  <p className="text-sm text-muted-foreground">
                    Normativa, responsabilità del dirigente, valutazione dei rischi, 
                    gestione della sicurezza.
                  </p>
                </div>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Modulo Pratico (4 ore)</h3>
                  <p className="text-sm text-muted-foreground">
                    Esercitazioni, case study, simulazioni di gestione, sviluppo di 
              ...
              <div className="bg-gray-50 border rounded-lg p-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">16 ore</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      5 anni (aggiornamento obbligatorio ogni 5 anni: 6 ore)
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  <summary className="font-semibold text-gray-900 flex items-center justify-between">
                    Responsabilità e Compiti del Dirigente
                    <span className="group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Definizione di dirigente secondo il D.Lgs 81/08</p>
                    <p>• Responsabilità civili e penali</p>
                    <p>• Compiti e funzioni</p>
                    <p>• Rapporto con RSPP e Datore di Lavoro</p>
                  </div>
                </details>
                ...
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  ...
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Comunicazione della sicurezza</p>
                    <p>• Coinvolgimento dei lavoratori</p>
                    <p>• Leadership in sicurezza</p>
                ...
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  ...
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    ...
                    <p>• Simulazioni di gestione</p>
                    <p>• Discussioni su problemi comuni</p>
                    <p>• Sviluppo di competenze di leadership</p>
                  </div>
                </details>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  "Competenze per gestire la sicurezza",
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 sticky top-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="font-semibold text-gray-900">16 ore</p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">Da 200 EUR + IVA</p>
                </div>
              ...
              {/* CTA */}
              <a
                href="https://wa.me/393465835685?text=Sono%20interessato%20al%20corso%20Dirigenti"
                target="_blank"
