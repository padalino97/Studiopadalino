...
export default function AggiornamentoDirigenti() {
  return (
    <CourseTemplate
      title="Corso di Aggiornamento Dirigenti"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="6 ore"
      type="online"
      
      description="Corso Corso di Aggiornamento Dirigenti. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
