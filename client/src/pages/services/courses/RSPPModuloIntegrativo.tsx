...
export default function RSPPModuloIntegrativo() {
  return (
    <CourseTemplate
      title="Corso per Datori di Lavoro RSPP - Modulo Integrativo"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="da 250,00 euro"
      type="presenza"
      location="Catania"
      description="Corso Corso per Datori di Lavoro RSPP - Modulo Integrativo. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
