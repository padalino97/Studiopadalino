...
export default function AggiornamentoLavoratori() {
  return (
    <CourseTemplate
      title="Corso di Aggiornamento per Lavoratori"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="6 ore"
      type="online"
      
      description="Corso Corso di Aggiornamento per Lavoratori. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
