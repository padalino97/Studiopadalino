...
export default function AggiornamentoRLSPiccole() {
  return (
    <CourseTemplate
      title="Corso Aggiornamento RLS (1-50 dipendenti)"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="4 ore"
      type="online"
      
      description="Corso Corso Aggiornamento RLS (1-50 dipendenti). I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
