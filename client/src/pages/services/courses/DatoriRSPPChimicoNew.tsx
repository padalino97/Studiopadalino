...
export default function DatoriRSPPChimicoNew() {
  return (
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Modulo Integrativo Chimico</span>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-red-900 to-transparent p-6 rounded-lg">
                  <p className="text-white font-bold text-lg">CHIMICO - PETROLCHIMICO</p>
                </div>
              </div>

              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso RSPP - Modulo Integrativo Chimico-Petrolchimico</h1>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>16 ore</strong> - Modulo specialistico per settore chimico
                </p>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20RSPP%20Modulo%20Chimico"
                  target="_blank"
          ...
          <div className="container">
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Questo modulo integrativo è specificamente dedicato al settore <strong>Chimico e Petrolchimico</strong> e fornisce al datore di lavoro <strong>informazioni specifiche per gestire in autonomia il Servizio di Prevenzione e Protezione dai rischi professionali</strong> nei settori indicati.
                </p>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-red-50 border-l-4 border-red-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Il modulo tecnico-integrativo è rivolto a <strong>tutti i titolari d'impresa che svolgano direttamente i compiti del Servizio di Prevenzione e Protezione nel settore Chimico e Petrolchimico</strong> e che abbiano già frequentato il modulo generale di 8 ore.
                </p>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Il modulo integrativo Chimico e Petrolchimico prevede la trattazione dei seguenti argomenti:
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Processo produttivo, organizzazione del lavoro e ambienti di lavoro</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Cenni sulle attività a rischio di incidente rilevante</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Cenni sulle industrie insalubri</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Rischi legati agli impianti e alle attrezzature di lavoro</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Manutenzione impianti e gestione fornitori</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Rischi incendio ed esplosioni e gestione dell'emergenza</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Dispositivi di protezione collettiva ed individuali</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-muted-foreground">Gestione dei rifiuti</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground">
                  <strong>16 ore</strong> (modulo specialistico per il settore chimico-petrolchimico)
                </p>
              </div>
