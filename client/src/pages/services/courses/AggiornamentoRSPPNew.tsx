...
export default function AggiornamentoRSPPNew() {
  return (
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <a href="/servizi/sicurezza-lavoro" className="hover:text-foreground transition-colors">RSPP</a>
              <span>/</span>
        ...
        <section className="py-12 md:py-16 bg-white border-b border-gray-200">
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso di Aggiornamento per Datori di Lavoro RSPP</h1>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>8 ore</strong>
                </p>
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-start gap-3 bg-indigo-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Datori di Lavoro RSPP</p>
                    </div>
                  </div>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20Aggiornamento%20RSPP"
                  target="_blank"
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Il D.lgs. 81/08, all'articolo 34, offre al Datore di Lavoro la possibilità di <strong>svolgere direttamente i compiti propri del Servizio di Prevenzione e Protezione (SPP)</strong>, assumendo quindi il ruolo di <strong>RSPP (Responsabile del Servizio di Prevenzione e Protezione)</strong> all'interno della propria azienda.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Questa scelta, spesso motivata da ragioni di controllo diretto sulla gestione della sicurezza o da considerazioni economiche iniziali, è però subordinata alla frequenza di uno specifico corso di formazione, la cui durata e contenuti sono definiti dall'<strong>Accordo Stato-Regioni del 17/04/2025</strong>.
                </p>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-blue-50 border-l-4 border-blue-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Il Corso aggiornamento per DLSPP previsto dal nuovo Accordo Stato-Regioni è rivolto a <strong>tutti i titolari d'impresa che svolgano direttamente i compiti del Servizio di Prevenzione e Protezione (RSPP)</strong>.
                </p>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <div className="mt-6 bg-yellow-50 border-l-4 border-yellow-600 p-6 rounded-lg">
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Nota importante:</strong> Qualora il datore di lavoro abbia frequentato i <strong>moduli specialistici</strong> e ne permangono le condizioni per gli stessi, l'aggiornamento dovrà riguardare anche le tematiche ivi previste.
                  </p>
                </div>
              </div>
