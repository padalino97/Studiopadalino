...
export default function HACCPCourse() {
  return (
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-12">
        <div className="container">
          ...
          <h1 className="font-display text-4xl font-bold mb-4">
            Corso HACCP Alimentaristi
          </h1>
          <p className="text-xl text-gray-300">
            Certificazione per operatori del settore alimentare
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4 leading-relaxed">
                HACCP (Hazard Analysis and Critical Control Points) è un sistema di gestione 
                della sicurezza alimentare obbligatorio per tutti gli operatori del settore 
                alimentare. Il corso fornisce le competenze necessarie per implementare e 
                mantenere il sistema HACCP.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                La formazione HACCP è richiesta dal Regolamento CE 852/2004 e dalle normative 
                nazionali per garantire la sicurezza igienico-sanitaria degli alimenti.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-3">
                {[
                  "Operatori del settore alimentare (obbligo di legge)",
                  "Addetti alla manipolazione di alimenti",
                  "Personale di cucina e ristorazione",
                  "Responsabili di laboratori alimentari",
                  "Chiunque lavori in aziende alimentari",
                ].map((item, i) => (
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Il corso combina lezioni teoriche con esercitazioni pratiche per sviluppare 
                competenze di gestione della sicurezza alimentare.
              </p>
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 mb-2">Modulo Teorico (6 ore)</h3>
                  <p className="text-sm text-muted-foreground">
                    Principi HACCP, identificazione dei pericoli, misure di controllo, 
                    igiene alimentare.
                  </p>
                </div>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Esercitazioni, case study, applicazione pratica dei principi HACCP 
                    in azienda.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 border rounded-lg p-6 space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Illimitata (aggiornamento consigliato ogni 3 anni)
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  ...
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Introduzione al sistema HACCP</p>
                    <p>• I 7 principi HACCP</p>
                    <p>• Analisi dei pericoli (biologici, chimici, fisici)</p>
                    <p>• Punti Critici di Controllo (CCP)</p>
                  </div>
                </details>
                ...
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  ...
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Regolamento CE 852/2004</p>
                    <p>• Igiene personale e del luogo di lavoro</p>
                    <p>• Pulizia e sanificazione</p>
                ...
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  ...
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Pericoli biologici (batteri, virus, parassiti)</p>
                    <p>• Pericoli chimici (pesticidi, additivi)</p>
                    <p>• Pericoli fisici (corpi estranei)</p>
                    <p>• Misure di controllo e prevenzione</p>
                  </div>
                </details>
                ...
                <details className="bg-white border rounded-lg p-4 cursor-pointer group">
                  ...
                  <div className="mt-4 text-sm text-muted-foreground space-y-2">
                    <p>• Implementazione HACCP in azienda</p>
                    <p>• Documentazione e registrazione</p>
                    <p>• Controlli e verifiche</p>
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  "Competenze per gestire la sicurezza alimentare",
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 sticky top-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">Illimitata</p>
                </div>
              ...
              {/* CTA */}
              <a
                href="https://wa.me/393465835685?text=Sono%20interessato%20al%20corso%20HACCP"
                target="_blank"
