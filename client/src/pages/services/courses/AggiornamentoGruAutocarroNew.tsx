...
export default function AggiornamentoGruAutocarroNew() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Ciao! Sono interessato al corso: Corso di Aggiornamento per Addetti alla Conduzione di Gru per Autocarro"
  );
      ...
      <div className="bg-slate-800/50 border-b border-slate-700">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-slate-400">
            ...
            <ChevronRight size={16} />
            <span className="text-slate-300">Corso di Aggiornamento per Addetti alla Conduzione di Gru per Autocarro</span>
          </div>
        </div>
      </div>
