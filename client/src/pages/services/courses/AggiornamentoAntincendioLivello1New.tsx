...
export default function AggiornamentoAntincendioLivello1New() {
  return (
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Corso Aggiornamento Antincendio Livello 1</span>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                ...
                <img 
                  src="https://images.unsplash.com/photo-1559027615-cd2628902d4a?w=600&h=400&fit=crop" 
                  alt="Aggiornamento Antincendio Livello 1" 
                  className="w-full h-auto rounded-lg shadow-lg"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-red-900 to-transparent p-6 rounded-lg">
                  <p className="text-white font-bold text-lg">RISCHIO BASSO</p>
                </div>
              </div>

              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso Aggiornamento Antincendio Livello 1</h1>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>2 ore</strong> - Aggiornamento quinquennale obbligatorio per addetti antincendio
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3 bg-red-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">2 ore</p>
                    </div>
                  </div>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20Aggiornamento%20Antincendio%20Livello%201"
                  target="_blank"
          ...
          <div className="container">
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-red-50 border-l-4 border-red-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 font-semibold mb-4">Rientrano tipicamente in questa categoria le attività:</p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">Non soggette ai controlli dei Vigili del Fuoco (attività non normate e non rientranti nell'Allegato I del DPR 151/2011)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">Caratterizzate da un basso rischio di sviluppo di incendi</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">Dove le probabilità di propagazione delle fiamme sono considerate scarse</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">Con presenza di sostanze infiammabili limitata e condizioni di esercizio che offrono scarsa possibilità di innesco</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <p className="text-foreground font-semibold mb-2">D.lgs. 81/08 e Decreti Ministeriali</p>
                    <p className="text-muted-foreground">D.lgs. 81/08 artt. 18, 37, 43 - D.M 2/09/21 e D.M. 3/09/21</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Il corso proposto prevede la trattazione dei seguenti contenuti minimi:
                </p>

                <div className="space-y-6">
                  <div className="border-l-4 border-red-600 pl-6">
                    <h3 className="text-2xl font-bold text-foreground mb-3">Riepilogo delle Procedure</h3>
                    <p className="text-muted-foreground">Rinfrescare le corrette procedure di emergenza, le modalità di allarme e le tecniche base di evacuazione</p>
                  </div>

                  <div className="border-l-4 border-orange-600 pl-6">
                    <h3 className="text-2xl font-bold text-foreground mb-3">Aggiornamenti Normativi</h3>
                    <p className="text-muted-foreground">Illustrare sinteticamente eventuali novità legislative o procedurali rilevanti, con focus sul D.M. 02/09/21</p>
                  </div>

                  <div className="border-l-4 border-yellow-600 pl-6">
                    <h3 className="text-2xl font-bold text-foreground mb-3">Registro Antincendio</h3>
                    <p className="text-muted-foreground">Prendere visione delle modalità di tenuta e importanza del registro dei controlli antincendio</p>
                  </div>

                  <div className="border-l-4 border-green-600 pl-6">
                    <h3 className="text-2xl font-bold text-foreground mb-3">Esercitazioni Pratiche (Dimostrative)</h3>
                    <p className="text-muted-foreground">Fornire istruzioni e dimostrazioni sull'uso corretto degli estintori portatili, che sono l'attrezzatura principale nelle attività di Livello 1</p>
                  </div>
                </div>

                <p className="text-sm text-muted-foreground mt-8 italic">
                  Il programma è strutturato per coprire i contenuti minimi richiesti per l'aggiornamento Livello 1 dall'Allegato III del D.M. 02/09/21.
                </p>
              </div>
