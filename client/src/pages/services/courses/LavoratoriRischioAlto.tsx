...
export default function LavoratoriRischioAlto() {
  return (
    <CourseTemplate
      title="Corso per Lavoratori Rischio Alto"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="16 ore"
      type="presenza"
      location="Catania"
      description="Corso Corso per Lavoratori Rischio Alto. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
