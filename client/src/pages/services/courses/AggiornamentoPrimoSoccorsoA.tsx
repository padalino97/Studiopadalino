...
export default function AggiornamentoPrimoSoccorsoA() {
  return (
    <CourseTemplate
      title="Corso Aggiornamento Primo Soccorso (Aziende Gruppo A)"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="6 ore"
      type="presenza"
      location="Catania"
      description="Corso Corso Aggiornamento Primo Soccorso (Aziende Gruppo A). I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
