...
export default function LavoratoriRischioAltoNew() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Rischio Alto</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-white border-b border-gray-200">
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso di Formazione per Lavoratori Rischio Alto</h1>
                <p className="text-lg text-muted-foreground mb-2">
                  <strong>Formazione Base + Specifica</strong>
                </p>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>16 ore</strong> (4 ore base + 12 ore specifica)
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3 bg-red-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">16 ore (4 base + 12 specifica)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-rose-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Aziende rischio alto (edilizia, chimica, sanità)</p>
                    </div>
                  </div>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20Lavoratori%20Rischio%20Alto"
                  target="_blank"
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Questo corso completo combina la <strong>formazione generale (4 ore)</strong> con la <strong>formazione specifica per rischio alto (12 ore)</strong>, fornendo una preparazione completa e conforme alla normativa vigente per settori ad elevata pericolosità.
                </p>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-red-50 border-l-4 border-red-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Il corso è destinato a <strong>tutte le aziende ad alto rischio</strong> che impiegano almeno un lavoratore subordinato, parasubordinato, volontario o un lavoratore autonomo in via esclusiva.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed font-semibold mb-3">
                  I macrosettori classificati a rischio alto comprendono:
                </p>
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span>Industria chimica e petrolchimica</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span>Sanità (ospedali, case di cura, con specifici rischi biologici, chimici, movimentazione pazienti)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span>Industria estrattiva e manifatturiera pesante</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span>Gestione dei rifiuti e attività di bonifica</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                    <span>Produzione e distribuzione di energia</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <div className="bg-red-50 border-l-4 border-red-600 p-6 rounded-lg">
                  <h3 className="text-2xl font-bold text-red-900 mb-4">MODULO 2 – Formazione Specifica Rischio Alto (12 ore)</h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground">
                  <strong>16 ore totali</strong>: 4 ore formazione generale + 12 ore formazione specifica
                </p>
              </div>
        ...
        {/* CTA Section */}
        <section className="py-12 md:py-16 bg-gradient-to-r from-red-600 to-rose-600">
          <div className="container">
