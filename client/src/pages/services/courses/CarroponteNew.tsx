...
export default function CarroponteNew() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Ciao! Sono interessato al corso: Corso per Addetti alla Conduzione Carroponte con Comando"
  );
      ...
      <div className="bg-slate-800/50 border-b border-slate-700">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-slate-400">
            ...
            <ChevronRight size={16} />
            <span className="text-slate-300">Corso per Addetti alla Conduzione Carroponte con Comando</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Corso per Addetti alla Conduzione Carroponte con Comando
            </h1>
