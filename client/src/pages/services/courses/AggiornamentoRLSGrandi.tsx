...
export default function AggiornamentoRLSGrandi() {
  return (
    <CourseTemplate
      title="Corso Aggiornamento RLS (piu di 50 lavoratori)"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="8 ore"
      type="online"
      
      description="Corso Corso Aggiornamento RLS (piu di 50 lavoratori). I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
