...
export default function LavoratoriRischioBasso() {
  return (
    <CourseTemplate
      title="Corso per Lavoratori Rischio Basso"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="8 ore"
      type="presenza"
      location="Catania"
      description="Corso Corso per Lavoratori Rischio Basso. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
