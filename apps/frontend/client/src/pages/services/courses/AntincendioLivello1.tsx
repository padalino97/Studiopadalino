...
export default function AntincendioLivello1() {
  return (
    <CourseTemplate
      title="Corso Antincendio Livello 1"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="4 ore"
      type="presenza"
      location="Catania"
      description="Corso Corso Antincendio Livello 1. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
