...
export default function DirigentiCantieriNew() {
  return (
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Con Modulo Cantieri</span>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                ...
                <img 
                  ...
                  alt="Dirigenti con Modulo Cantieri" 
              ...
              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso per Dirigenti con Modulo Aggiuntivo Cantieri</h1>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>18 ore</strong> (12 ore base + 6 ore cantieri)
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3 bg-orange-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">18 ore (12 base + 6 cantieri)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-amber-50 p-4 rounded-lg">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Settore</p>
                      <p className="text-sm text-muted-foreground">Costruzioni e cantieri temporanei/mobili</p>
                    </div>
                  </div>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20Dirigenti%20con%20Modulo%20Cantieri"
                  target="_blank"
          ...
          <div className="container">
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Il corso per dirigenti in materia di salute e sicurezza sul lavoro <strong>fornisce ai partecipanti una serie di conoscenze e competenze specifiche per gestire correttamente la sicurezza all'interno dell'azienda</strong>.
                </p>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-orange-50 border-l-4 border-orange-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Il corso è rivolto a tutti coloro che, secondo la definizione del D.lgs. 81/2008 (art. 2, comma 1, lettera d), <strong>esercitano funzioni di gestione o supervisione, attuando le direttive del datore di lavoro</strong> e che <strong>operano nei settori ATECO in cui siano coinvolti cantieri temporanei o mobili</strong>.
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    <p className="font-bold text-orange-900 mb-2">1. Costruzioni (ATECO F):</p>
                  ...
                  <div>
                    <p className="font-bold text-orange-900 mb-2">2. Altri settori con attività in cantiere:</p>
                    <ul className="space-y-2 text-gray-700 ml-4">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                {/* Modulo Base */}
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-foreground mb-4">Modulo Base Dirigenti (12 ore)</h3>
                  <p className="text-muted-foreground mb-4">Suddiviso in 4 moduli:</p>
                  <div className="space-y-3">
                    <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-lg">
                      <p className="font-semibold text-blue-900">1. Modulo Giuridico-Normativo</p>
                    </div>
                    <div className="bg-indigo-50 border-l-4 border-indigo-600 p-4 rounded-lg">
                      <p className="font-semibold text-indigo-900">2. Organizzazione della Sicurezza</p>
                    </div>
                    <div className="bg-purple-50 border-l-4 border-purple-600 p-4 rounded-lg">
                      <p className="font-semibold text-purple-900">3. Compiti Specifici del Dirigente</p>
                    </div>
                    <div className="bg-violet-50 border-l-4 border-violet-600 p-4 rounded-lg">
                      <p className="font-semibold text-violet-900">4. Comunicazione</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-orange-50 border-l-4 border-orange-600 p-6 rounded-lg">
                  <h3 className="text-2xl font-bold text-orange-900 mb-4">Modulo Aggiuntivo Cantieri (6 ore)</h3>
                  <p className="text-gray-700 mb-4">Compiti specifici del dirigente dell'impresa affidataria nei cantieri temporanei e mobili:</p>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">La redazione dei <strong>piani di sicurezza</strong>: finalità, tempi e contenuti</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Le <strong>misure generali di tutela</strong> secondo quanto previsto dall'art. 95 del d.lgs. n. 81/2008</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Gli <strong>obblighi del datore di lavoro, dei dirigenti e dei preposti</strong> di cui all'art. 96 del d.lgs. n. 81/2008</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Il <strong>cronoprogramma dei lavori</strong></span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-orange-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground">
                  <strong>18 ore totali</strong>: 12 ore modulo base + 6 ore modulo cantieri
                </p>
              </div>
