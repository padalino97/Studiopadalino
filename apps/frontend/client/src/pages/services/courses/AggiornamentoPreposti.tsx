...
export default function AggiornamentoPreposti() {
  return (
    <CourseTemplate
      title="Corso Aggiornamento Preposti"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="6 ore"
      type="online"
      
      description="Corso Corso Aggiornamento Preposti. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
