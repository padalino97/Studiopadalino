...
export default function LavoratoriRischioBassoNew() {
  return (
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Rischio Basso</span>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-white border-b border-gray-200">
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso di Formazione per Lavoratori Rischio Basso</h1>
                <p className="text-lg text-muted-foreground mb-2">
                  <strong>Formazione Base + Specifica</strong>
                </p>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>8 ore</strong> (4 ore base + 4 ore specifica)
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3 bg-green-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">8 ore (4 base + 4 specifica)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-emerald-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Aziende rischio basso (commercio, ristorazione, uffici)</p>
                    </div>
                  </div>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20Lavoratori%20Rischio%20Basso"
                  target="_blank"
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Questo corso completo combina la <strong>formazione generale (4 ore)</strong> con la <strong>formazione specifica per rischio basso (4 ore)</strong>, fornendo una preparazione completa e conforme alla normativa vigente.
                </p>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-green-50 border-l-4 border-green-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Il corso è destinato a <strong>tutte le aziende a basso rischio</strong> che impiegano almeno un lavoratore subordinato, parasubordinato, volontario o un lavoratore autonomo in via esclusiva.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed font-semibold mb-3">
                  I macrosettori classificati a rischio basso comprendono:
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>Commercio all'ingrosso e al dettaglio</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>Attività artigianali (carrozzerie, officine, lavanderie, parrucchieri, panificatori, pasticceri)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>Strutture ricettive e ristorazione</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>Settore immobiliare</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>Associazioni ricreative, culturali e sportive</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>Servizi domestici e organismi territoriali</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <div className="bg-green-50 border-l-4 border-green-600 p-6 rounded-lg">
                  <h3 className="text-2xl font-bold text-green-900 mb-4">MODULO 2 – Formazione Specifica Rischio Basso (4 ore)</h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground">
                  <strong>8 ore totali</strong>: 4 ore formazione generale + 4 ore formazione specifica
                </p>
              </div>
