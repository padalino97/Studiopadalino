...
export default function AggiornamentoPrimoSoccorsoBCNew() {
  return (
        ...
        <section className="bg-gray-50 border-b border-gray-200 py-4">
          <div className="container">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Corso Aggiornamento Primo Soccorso (Aziende Gruppo B e C)</span>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                ...
                <img 
                  ...
                  alt="Aggiornamento Primo Soccorso B e C" 
                  className="w-full h-auto rounded-lg shadow-lg"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-green-900 to-transparent p-6 rounded-lg">
                  <p className="text-white font-bold text-lg">GRUPPO B E C</p>
                </div>
              </div>

              {/* Contenuto */}
              <div>
                <h1 className="text-4xl font-bold text-foreground mb-4">Corso Aggiornamento Primo Soccorso (Aziende Gruppo B e C)</h1>
                <p className="text-lg text-muted-foreground mb-6">
                  Durata <strong>4 ore</strong> - Aggiornamento triennale obbligatorio per addetti primo soccorso
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3 bg-green-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">4 ore</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-teal-50 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Aggiornamento triennale</p>
                    </div>
                  </div>
                </div>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/393465835685?text=Sono%20interessato%20al%20Corso%20Aggiornamento%20Primo%20Soccorso%20Gruppo%20B%20e%20C"
                  target="_blank"
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Il corso si pone gli obiettivi di <strong>aggiornare e consolidare le competenze acquisite nel corso base</strong>; di ripassare protocolli e procedure di emergenza; di addestrare nuovamente alle manovre di primo soccorso, con attenzione alle tecniche BLS.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  L'aggiornamento è previsto in conformità al D.M. 388/2003 che prevede un <strong>aggiornamento triennale</strong> per mantenere le abilità pratiche.
                </p>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200 bg-green-50 border-l-4 border-green-600 p-6 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Il corso di aggiornamento primo soccorso di 4 ore è rivolto principalmente ai <strong>lavoratori designati come addetti al primo soccorso in azienda</strong>, in base a quanto previsto dal D.lgs. 81/2008 (Testo Unico sulla Sicurezza sul Lavoro) e dal DM 388/2003, nello specifico ad Aziende dei Gruppi B e C.
                </p>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <p className="text-foreground font-semibold mb-2">D.lgs. 81/08 e D.M. 388/2003</p>
                    <p className="text-muted-foreground">D.lgs. 81/08 artt. 18, 43, 45 - D.M 388/2003 (Decreto Ministeriale 15 luglio 2003)</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12 pb-12 border-b border-gray-200">
                ...
                <div className="space-y-8">
                  ...
                  <div className="border-l-4 border-green-600 pl-6">
                    <h3 className="text-2xl font-bold text-foreground mb-4">Modulo 1 (1 ora)</h3>
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                        <span className="text-muted-foreground">Modalità di allerta del sistema di emergenza</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                        <span className="text-muted-foreground">Riconoscimento delle principali emergenze sanitarie</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  ...
                  <div className="border-l-4 border-emerald-600 pl-6">
                    <h3 className="text-2xl font-bold text-foreground mb-4">Modulo 2 - Esercitazioni Pratiche (3 ore)</h3>
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                        <span className="text-muted-foreground">Tecniche di rianimazione cardiopolmonare (BLS)</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                        <span className="text-muted-foreground">Manovre di disostruzione delle vie respiratorie</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                        <span className="text-muted-foreground">Tecniche di immobilizzazione di arti e traumatizzati</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                        <span className="text-muted-foreground">Gestione di ferite, emorragie, ustioni</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
