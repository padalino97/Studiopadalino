...
export default function AntincendioLivello2() {
  return (
    <CourseTemplate
      title="Corso Antincendio Livello 2"
      subtitle="Formazione professionale conforme al D.Lgs 81/08"
      duration="8 ore"
      type="presenza"
      location="Catania"
      description="Corso Corso Antincendio Livello 2. I contenuti dettagliati saranno aggiunti a breve."
      objectives={[
